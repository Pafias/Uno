...
public class MapBuilder {
     ...
     * @return the instance of this class
     */
    public MapBuilder setDisplayName(String displayName) {
    ...
    /**
     * Sets the ItemFlags of the ItemStack
     *
     * @param itemFlags the ItemFlags of the ItemStack
     * @return the instance of this class
     */
    public MapBuilder setItemFlags(ItemFlag... itemFlags) {
    ...
    public ItemStack build() {
        ItemStack item = new ItemStack(isNewestVersion ? Material.FILLED_MAP : Material.valueOf("MAP"));

        item.getItemMeta().setDisplayName(displayName);
        item.getItemMeta().setLore(lore);
        if (itemFlags != null && !itemFlags.isEmpty())
            itemFlags.forEach(flag -> item.getItemMeta().addItemFlags(flag));
